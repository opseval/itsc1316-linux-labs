...
| **Scripts** | `setup-intro.sh`, `check-intro.sh` (in this folder of your cloned repo) |
...
multipass transfer labs/module-01-introduction-to-linux/setup-intro.sh labvm:/home/ubuntu/
multipass transfer labs/module-01-introduction-to-linux/check-intro.sh labvm:/home/ubuntu/
```

Now open a shell inside the VM and run the setup:
